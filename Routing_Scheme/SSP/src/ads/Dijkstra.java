...
//This class is implementation of Dijkstra for only Part 1 because I am terminating the algorithm when I reach destination node for efficiency.
//In part 2, the same class is called 'DijkstraForRouting' which finds shortest path to all other nodes.
...
public class Dijkstra {
	...
	{
		Fibonacci_Heap f1=new Fibonacci_Heap();      //Initializing Fibonacci Heap	
		Node nd;		
		Node ptr;
		...
		while(f1.nodeCount!=0)
		{
			...
			if(nd.nodeID==destId)
			{
				...
				break;                     //terminate if destination node has been extracted (reached).
			}
